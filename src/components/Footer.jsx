    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <div>
                ...
                <div className="text-xs text-gray-400">Technology & Trading</div>
              </div>
            </div>
            <p className="text-gray-400 mb-4">
              Công ty Cổ phần Công nghệ Thương mại Tân Phong - Đối tác tin cậy trong lĩnh vực công nghệ thông tin
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['home', 'about', 'products', 'services', 'contact'].map((id, index) => (
                <li key={id}>
                  <button 
                    onClick={() => scrollToSection(id)} 
                    className="hover:text-primary transition-colors"
                  >
                    {['Trang chủ', 'Giới thiệu', 'Sản phẩm', 'Dịch vụ', 'Liên hệ'][index]}
                  </button>
                </li>
              ))}
            </ul>
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-sm text-gray-400">
          <p>© 2024 Công ty Cổ phần Công nghệ Thương mại Tân Phong. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
