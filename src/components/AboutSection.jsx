      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="space-y-6 order-1 md:order-2">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              Đến nay, Tân Phong đã trở thành đối tác chiến lược của nhiều doanh nghiệp và tổ chức giáo dục trong hành trình chuyển đổi số, 
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-linear-to-br from-blue-50 to-indigo-50 p-8 rounded-2xl text-center">
            ...
            <div className="bg-linear-to-br from-purple-50 to-pink-50 p-8 rounded-2xl text-center">
            ...
            <div className="bg-linear-to-br from-green-50 to-teal-50 p-8 rounded-2xl text-center">
