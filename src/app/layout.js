...
export const metadata = {
  title: {
    default: 'Tân Phong Technology - Giải pháp Chuyển đổi số & ERP cho Doanh nghiệp',
    template: '%s | Tân Phong Technology'
  },
  description: 'Công ty Cổ phần Công nghệ Thương mại Tân Phong - Chuyên cung cấp giải pháp ERP, EdTech, phát triển phần mềm và chuyển đổi số cho doanh nghiệp tại Hải Phòng và toàn quốc. Liên hệ: 0989 150 269',
  keywords: [
    'giải pháp ERP',
  ...
  openGraph: {
    ...
    description: 'Đối tác tin cậy trong chuyển đổi số - Cung cấp giải pháp ERP, EdTech và phát triển phần mềm cho doanh nghiệp',
    images: [
      {
